CREATE PROCEDURE ATIVIDADE_CANCELAR
...
BEGIN
	...
	BEGIN TRY
		BEGIN TRANSACTION
				...
				SET @ATV_Observacao = CONCAT('Cancelada a atividade de código ',@ATV_Tid,'.')
	...
	BEGIN CATCH
		...
		EXEC LOG_ERRO_INSERIR @ERRO, 'ATIVIDADE_CANCELAR'
